      ...
      {loading ? (
        ...
        <>
          <SimpleGrid columns="2" spacing="80" mb="8">
            <Box>
              {" "}
              <Text fontSize="45" fontWeight="bold" ml="4">
                <b>List of all Book</b>s
              </Text>{" "}
            </Box>
            <Box>
              <Button float="right" onClick={handleSearch}>
                {" "}
                <Search2Icon />{" "}
              </Button>
              <Input
                ...
                <div key={index}>
                  ...
                  >
                    <Center shadow={"base"} mb="4">
                      <Image
                        src={"http://localhost:5000" + data.cover_photo}
                    ...
                    <Center>
                      <Box>
                        ...
                        <Center>
                          <Popover usePortal>
                            <PopoverTrigger>
                              <Button colorScheme={"facebook"} size="sm" mb="3">
                        ...
                        <Center>
                          <Button
                            variant={"link"}
                            mb="4"
                            onClick={() => handlePurchased(data._id)}
                          >
                            Purchase
                          </Button>
                        </Center>
